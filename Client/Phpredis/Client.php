...
$versionBetween = static function (string $low, string $high) use ($phpRedisVersion): bool {
    return \version_compare($phpRedisVersion, $low, '>=') &&
        \version_compare($phpRedisVersion, $high, '<')
        ;
};
if ($versionBetween('3.0.0', '4.0.0')) {
    /**
...
} elseif ($versionBetween('4.0.0', '5.0.0.')) {
    throw new \Exception("No logger implementation provided for phpredis '{$phpRedisVersion}'.");
} elseif ($versionBetween('5.0.0', '6.0.0')) {
    /**
     * PHP Redis client with logger.
     *
     * @author Henrik Westphal <henrik.westphal@gmail.com>
